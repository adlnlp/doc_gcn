...
## Graph Construction
We use GCNs to enhance the proposed four aspect feature representations: Appearance, Density, Semantic and Syntactic. Those GCNs have the same architecture but different node and edge representations. We are generally classified into two types based on distinct edge representations：
